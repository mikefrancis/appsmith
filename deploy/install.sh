...
(
    ...
    curl --remote-name-all --silent --show-error \
        https://raw.githubusercontent.com/mikefrancis/appsmith/release/deploy/template/docker-compose.yml.sh \
        https://raw.githubusercontent.com/mikefrancis/appsmith/release/deploy/template/mongo-init.js.sh \
        https://raw.githubusercontent.com/mikefrancis/appsmith/release/deploy/template/docker.env.sh \
        https://raw.githubusercontent.com/mikefrancis/appsmith/release/deploy/template/nginx_app.conf.sh \
        https://raw.githubusercontent.com/mikefrancis/appsmith/release/deploy/template/encryption.env.sh
)
